...
def get_swift_header(class_name: str) -> str:
    script = f"/bin/bash -c 'echo -e \"import QuartzCore\n:type lookup {class_name}\" | swift repl"
...
def generate(class_name: str) -> None:
    print(class_name)
    output_path = f"{generated_dir_path}/{target}/wrap/{platform}/{class_name}+.{platform}.generated.swift"
