...
extension Modify.DynamicMemberWrap where T: CALayer {
    ...
    @discardableResult
    @_disfavoredOverload
    public func resizeSublayers(withOldSize size: CoreFoundation.CGSize) -> T {
    ...
    @discardableResult
    @_disfavoredOverload
    public func resize(withOldSuperlayerSize size: CoreFoundation.CGSize) -> T {
    ...
    @discardableResult
    @_disfavoredOverload
    public func addConstraint(_ c: QuartzCore.CAConstraint) -> T {
